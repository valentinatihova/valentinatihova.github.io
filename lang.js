const LanguageDataArr = {
  ...
  "project_subtitle_11": {
    en: "Advertising company for computer games",
    ru: "Развитие рекламной компании интернет-магазина по компьютерным играм",
  },
  "project_11": {
    en: "Development of an advertising company for an online store for computer games, taking into account regional distribution.",
    ru: "Выявление определяющие успешность игры закономерности. Позволяет сделать ставку на потенциально популярный продукт и спланировать рекламные кампании.",
  },
  "project_subtitle_10": {
    en: "Сreating an automatic Tableau report",
    ru: "Автоматизация отчетности в Tableau",
  },
  "project_10": {
    en: "Tableau dashboard for Yandex.Zen.",
    ru: "Создание аналитического отчета (дашборд) для Яндекс.Дзен в Tableau.",
  },
  "project_subtitle_9": {
    en: "Advertising company for computer games",
    ru: "Развитие рекламной компании интернет-магазина по компьютерным играм",
